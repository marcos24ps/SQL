...
select * from products where product_name like '%Pâté%' or product_name like 'Queso%';
select * from products where discontinued=0 order by product_name limit 10;
select (units_in_stock * unit_price) as Total from products where discontinued=0 order by Total desc;
